...
void invertWords();
void push(stackElmtPointer stack,stackElmtPointer);
...
int main(void){
	stackElmtPointer pilha = malloc(sizeof(stackElement));
	pilha->charValue = 'a';
	pilha->value = 1;
	pilha->nextNode = NULL;
	
	stackElmtPointer novoNo = malloc(sizeof(stackElement));
	novoNo->charValue = 'b';
	novoNo->value = 2;
	novoNo->nextNode = NULL;
